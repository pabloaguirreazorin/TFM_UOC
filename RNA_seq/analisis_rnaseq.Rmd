...
rankings_ad_nci <- sign(salida_ad_nci$log2foldChange) * (-log10(
...
# Calculo los rankings
rankings_ad_mci <- sign(salida_ad_mci$log2foldChange) * (-log10(
...
# Calculo los rankings
rankings_mci_nci <- sign(salida_mci_nci$log2foldChange) * (-log10(
